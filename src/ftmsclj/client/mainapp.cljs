(ns ftms-clj.client.mainapp
  (:require [noir.cljs.client.watcher :as watcher]
            [clojure.browser.repl :as repl]
            [waltz.state :as state]
            [ftms-clj.client.appstate :as app]
            [ftms-clj.client.layouts.blank :as blank]
            [ftms-clj.client.layouts.welcome :as welcome]
            [ftms-clj.client.layouts.fluid :as fluid]
            [ftms-clj.client.oneapp :as oneapp])
